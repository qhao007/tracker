...
class TestEmptyValueFilters:
    ...
    def test_cp_filter_empty_feature(self, client, test_project, cleanup_cps):
        ...
        response = client.get(f'/api/cp?project_id={test_project["id"]}&feature=')
        assert response.status_code == 200
        data = json.loads(response.data)
        assert isinstance(data, list)
    
    def test_tc_filter_empty_owner(self, client, test_project, cleanup_tcs):
        ...
        response = client.get(f'/api/tc?project_id={test_project["id"]}&owner=')
        assert response.status_code == 200
        data = json.loads(response.data)
        assert isinstance(data, list)
    
    def test_tc_filter_empty_category(self, client, test_project, cleanup_tcs):
        ...
        response = client.get(f'/api/tc?project_id={test_project["id"]}&category=')
        assert response.status_code == 200
        data = json.loads(response.data)
        assert isinstance(data, list)
...
class TestSpecialCharacters:
    ...
    def test_cp_feature_special_chars(self, client, test_project, cleanup_cps):
    ...
    def test_tc_testbench_sql_injection(self, client, test_project, cleanup_tcs):
    ...
    def test_tc_scenario_chinese_chars(self, client, test_project, cleanup_tcs):
    ...
    def test_tc_test_name_emoji(self, client, test_project, cleanup_tcs):
    ...
    def test_tc_scenario_newline(self, client, test_project, cleanup_tcs):
    ...
    def test_tc_scenario_json_string(self, client, test_project, cleanup_tcs):
    ...
    def test_tc_feature_xss_attempt(self, client, test_project, cleanup_tcs):
...
class TestLongInput:
    ...
    def test_cp_feature_long_input(self, client, test_project, cleanup_cps):
    ...
    def test_tc_test_name_long_input(self, client, test_project, cleanup_tcs):
...
class TestPaginationBoundary:
    ...
    def test_limit_zero(self, client, test_project):
        """API-BOUND-008: limit=0 返回空列表"""
        response = client.get(f'/api/tc?project_id={test_project["id"]}&limit=0')
        assert response.status_code == 200
        data = json.loads(response.data)
        # limit=0 应该返回空列表或全部数据
        assert isinstance(data, list)
    
    def test_limit_negative(self, client, test_project):
        """API-BOUND-009: limit=-1 处理"""
        response = client.get(f'/api/tc?project_id={test_project["id"]}&limit=-1')
        assert response.status_code in [200, 400]
        if response.status_code == 200:
            data = json.loads(response.data)
            assert isinstance(data, list)
    
    def test_offset_out_of_range(self, client, test_project):
        """API-BOUND-010: offset 超范围 (99999)"""
        response = client.get(f'/api/tc?project_id={test_project["id"]}&offset=99999')
        assert response.status_code == 200
        data = json.loads(response.data)
        # offset 超范围应该返回空列表
        assert isinstance(data, list)
    
    def test_large_limit_value(self, client, test_project):
        """API-PAGE-004: limit=10000 大值处理"""
        response = client.get(f'/api/tc?project_id={test_project["id"]}&limit=10000')
        assert response.status_code == 200
        data = json.loads(response.data)
        assert isinstance(data, list)
...
class TestInvalidEnumValues:
    ...
    def test_tc_invalid_status(self, client, test_project):
    ...
    def test_cp_invalid_priority(self, client, test_project, cleanup_cps):
...
class TestInvalidIds:
    ...
    def test_invalid_cp_id(self, client, test_project):
        """API-BOUND-014: 无效 CP ID 访问"""
        response = client.get(f'/api/cp/99999?project_id={test_project["id"]}')
        assert response.status_code == 404
    
    def test_invalid_tc_id(self, client, test_project):
...
class TestFilterCombinations:
    ...
    def test_multiple_filters_combined(self, client, test_project, cleanup_tcs):
    ...
    def test_empty_feature_list(self, client, test_project):
    ...
    def test_feature_with_spaces(self, client, test_project, cleanup_cps):
...
class TestSortingBoundary:
    ...
    def test_sort_by_invalid_field(self, client, test_project):
        """API-SORT-004: 无效排序字段"""
        response = client.get(f'/api/tc?project_id={test_project["id"]}&sort_by=invalid_field')
        # 应该返回错误或忽略并使用默认排序
        assert response.status_code in [200, 400]
    
    def test_sort_order_asc(self, client, test_project):
        """API-SORT-002: 升序排序"""
        response = client.get(
    ...
    def test_sort_order_desc(self, client, test_project):
        """API-SORT-002: 降序排序"""
        response = client.get(
