...
> **版本**: v0.7.0 | **更新日期**: 2026-02-15 | **状态**: 📋 规划中
...
| # | 功能 | 优先级 | 预估时间 | 状态 |
|---|------|--------|----------|------|
| #10 | 导入功能 (CP/TC) | P1 | 20h | 📋 规划 |
| #11 | 导出功能 (CP/TC) | P1 | 13h | 📋 规划 |
| #ISSUE-001 | 项目选择框宽度修复 | P3 | 0.5h | 📋 规划 |
| - | TS 类型修复 | Tech Debt | - | 📋 规划 |
...
- [ ] 运行 `npx tsc --noEmit` 无 @types/node 相关错误
- [ ] 无 TS7006 错误
- [ ] 无 TS2353 错误
- [ ] 无 TS18047 错误
